...
//                        Toast.makeText(QuestManagementBackup.this, "Max quests reached!", Toast.LENGTH_SHORT).show();
//                        return;
//                    }
...
//                DocumentReference docRef = db.collection("quest").document(storedUsername + "Quest" + (lastClickedQuestId));
...
//                Toast.makeText(QuestManagementBackup.this, "exit", Toast.LENGTH_SHORT).show();
//                recreate();
//            }
//        });
//
...
//            @Override
//            public void onClick(View v) {
//                Toast.makeText(QuestManagementBackup.this, "stats", Toast.LENGTH_SHORT).show();
//                Intent intent = new Intent(QuestManagementBackup.this, ProgressionPage.class);
...
//                    rewardsIntButton.setVisibility(View.GONE);
//                    rewardsStrButton.setVisibility(View.GONE);
//                    Toast.makeText(QuestManagementBackup.this, "close", Toast.LENGTH_SHORT).show();
//                } else {
...
//                    Toast.makeText(QuestManagementBackup.this, "open", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
//
...
//                    Toast.makeText(QuestManagementBackup.this, "New rating: " + rating, Toast.LENGTH_SHORT).show();
...
//            @Override
//            public void onClick(View v) {
//                Toast.makeText(QuestManagementBackup.this, "cancel quest edit", Toast.LENGTH_SHORT).show();
//                editQuestGroup.setVisibility(View.GONE);
//            }
//        });
//
...
//                    editQuestGroup.setVisibility(View.GONE);
//                    Toast.makeText(QuestManagementBackup.this, "Quest " + lastClickedQuestId + " updated!", Toast.LENGTH_SHORT).show();
//                    recreate();
//                }
//            }
//        });
...
//
//        // test message
//        Toast.makeText(QuestManagementBackup.this, "New Quest Added: Quest " + questId, Toast.LENGTH_SHORT).show();
//
//        groupCount++;
//        questId++;
